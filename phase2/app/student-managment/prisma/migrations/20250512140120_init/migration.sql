/*
  ...
  - You are about to drop the `SectionInstructor` table. If the table is not empty, all the data it contains will be lost.
...
INSERT INTO "new_Section" ("campus", "capacity", "courseNo", "dow", "place", "section", "status", "timing") SELECT "campus", "capacity", "courseNo", "dow", "place", "section", "status", "timing" FROM "Section";
DROP TABLE "Section";
